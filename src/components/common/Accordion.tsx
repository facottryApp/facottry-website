...
export const Accordion = ({ title, themes }: Props) => {
    return (
        <section className="w-full">
            <details className="bg-slate-200 p-4 rounded-xl shadow-md group max-h-[56px] overflow-x-hidden max-w-screen-lg open:!max-h-[70vh] transition-[max-height] duration-500 dark:text-white dark:bg-darkblue300">
                <summary
