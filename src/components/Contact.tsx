...
export const Contact = () => {
    return (
        <div className="py-8 lg:py-16 mx-auto max-w-screen-md">
            <h2 className="mb-2 text-4xl font-extrabold text-center text-gray-900">Contact Us</h2>
            <p className="mb-8 lg:mb-16 font-light text-center text-gray-500">Got a technical issue or Need details about our Business plan? Let us know.</p>
            <form className="space-y-8 bg-bgblue200 p-10 rounded-xl">
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="subject" className="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 " placeholder="What is this related to?" required />
                </div>
